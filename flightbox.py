...
arg_parser.set_defaults(log_file='/home/pi/opt/flightbox/flightbox.log')
...
def flightbox_init():
    ...
    # create formatter
    logging_formatter = logging.Formatter('%(asctime)s %(process)-5d %(processName)-25s %(name)-35s %(levelname)-8s %(message)s')
...
def flightbox_main():
    ...
    try:
        ...
        input_network_sbs1 = InputNetworkSbs1(data_hub, '127.0.0.1', 30003, message_types=['1', '2', '3', '4', '5'])
